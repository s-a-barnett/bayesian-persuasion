...
ggplot() +
  geom_point(data=d_rsa_pp, aes(x=agent1stick, y=empirical_stat)) +
  # geom_errorbar(data=d_rsa_pp, aes(x=agent1stick, ymin=ci_lower, ymax=ci_upper), width=0) +
  geom_point(data=d_rsa_pp, aes(x=agent1stick, y=MAPmodel), colour="red") +
