...
ggplot() + 
  ...
  geom_hline(yintercept = 50, linetype = 'dotted') +
  geom_line(data=filter(d_model, judge == 'J1'), aes(x=stick1, y=percent_isLong_1, color=agentBias, group=agentBias)) + 
  ggthemes::theme_few() +
  labs(x = 'agent 1 stick length', y = 'belief about mean') +
  xlim(0.5,1)+
  ylim(0,100)
...
ggplot() + 
  ...
  geom_hline(yintercept = 50, linetype = 'dotted') +
  geom_line(data=filter(d_model, judge == 'J0'), aes(x=stick1, y=percent_isLong_1)) + 
  ggthemes::theme_few() +
  labs(x = 'agent 1 stick length', y = 'belief about mean') +
  xlim(0.5,1)+
  ylim(0,100)
...
beliefChange.d %>%
  ...
  ggplot(aes(x = agent2stick, y = empirical_stat)) +
    ...
    geom_hline(yintercept = 50, linetype = 'dotted') +
    facet_grid(speaker_pref ~ agent1stick) +
    ylim(0, 100) + 
    ggthemes::theme_few() +
