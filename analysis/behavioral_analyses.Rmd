...
library(lmerTest)
library(broom.mixed)
d <- read_csv('../stickgame/human-experiments/dataFromMongo_prolificPilot1.csv')
```
...
beliefChange.d %>%
  ...
  bind_rows(data.frame(agent2stick = c(0.575,0.625, 0.775, 0.825), empirical_stat = c(41, 44, 54, 58), src = 'baseline')) %>%
