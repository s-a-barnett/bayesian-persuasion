...
df0 = pd.read_csv('results/posterior-bias0.csv')
df2 = pd.read_csv('results/posterior-bias2.csv')
df5 = pd.read_csv('results/posterior-bias5.csv')
df10 = pd.read_csv('results/posterior-bias10.csv')
...
fig = ax.get_figure();
fig.savefig('posterior-plot.png');
